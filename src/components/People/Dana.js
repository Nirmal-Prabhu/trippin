        ...
        <div>
          <div className={classes.container}>
              ...
              <GridItem xs={12} sm={12} md={8}>
                <div className={classes.profile}>
                  ...
                  <div className={classes.name}>
                    <h3 className={classes.title}>Pranjal Tiwari</h3>
                    <h6>INDIA</h6>
            ...
            <div className={classes.description}>
              <p>
                Pranjal Tiwari has travelled far and wide, having been with us from the start as a creator. His in-depth and reliable knowledge is very useful when organising trips{" "}
              </p>
            </div>
            <GridContainer justify="center">
